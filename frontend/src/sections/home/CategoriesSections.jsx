...
export default function CategoriesSections() {
    return (
        <section className='
            flex flex-col w-full items-center mb-25 mt-25
            md:mb-35 md:mt-35
        '>
            <div className='
                    grid grid-cols-2 w-[70vw] justify-items-center gap-10 text-center text-gray-dark
                    md:grid-cols-4 md:w-auto md:gap-16
                '
            >
                <Link to={'/cursos'}>
                    <div className='flex flex-col gap-4 cursor-pointer items-center'>
                        <div className='w-25 h-25 rounded-full bg-orange-base md:w-[clamp(100px,13vw,180px)] md:h-[clamp(100px,13vw,180px)]'>
