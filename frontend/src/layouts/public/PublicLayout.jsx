...
export default function PublicLayout({ children, bannerHome }) {
  return (
    <main className="min-h-screen w-full flex flex-col bg-gray">
      ...
      {/* ================= HEADER ================= */}
      <header className="w-full text-white bg-orange-base md:bg-orange-light">
        <div className="
          max-w-[1400px]
          mx-auto
          flex
        ...
        ">
          ...
          ">
            <Link
              to="/"
              className="flex items-center gap-2 text-xs w-full md:text-sm md:w-auto"
            >
              <img src={stores} alt="Nossas Lojas" className="w-6 h-6 md:w-8 md:h-8" />
            ...
            <a
              ...
              className="
                flex items-center gap-2 bg-gray-base hover:bg-gray-base/80
                px-3 py-2 rounded-md text-xs md:w-auto md:text-sm whitespace-nowrap
              "
            >
              <img src={whatsapp} alt="WhatsApp" className="h-[18px] md:h-[22px]" />
      ...
      {/* ================= FOOTER ================= */}
      <footer className="w-full mt-auto bg-orange-base">
        <div className="
        ...
        <div className="
          bg-orange-light text-white justify-between w-full px-6 py-6 flex flex-col gap-3
          md:flex-row md:items-center md:pl-20 md:px-15
        ">
          <p className="text-center md:text-left text-sm md:text-base">
            © 2023 Novamix Food Service Comércio de Alimentos Ltda. Todos os direitos reservados.
          </p>

          <div className="flex flex-col mt-5 md:flex-row md:gap-7 items-center md:text-xl md:mt-0">
            <p className="text-base">Desenvolvido por</p>

            <div className="flex gap-5">
              <a href="https://mthcode.com.br" target="_blank" className="font-bold cursor-pointer">
                MTHCODE
              </a>
